...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ElasticServiceManagerException.class)
    public ResponseEntity<ErrorMessage> handleManagerException(ElasticServiceManagerException exception){
